...
public class SqlGroupedWindowFunction extends SqlFunction {
    ...
    public final org.apache.calcite.sql.SqlGroupedWindowFunction groupFunction;
    ...
    public SqlGroupedWindowFunction(
            String name,
            SqlKind kind,
            org.apache.calcite.sql.SqlGroupedWindowFunction groupFunction,
     ...
     */
    public org.apache.calcite.sql.SqlGroupedWindowFunction auxiliary(SqlKind kind) {
     ...
     * @param kind Kind
     */
    public org.apache.calcite.sql.SqlGroupedWindowFunction auxiliary(String name, SqlKind kind) {
        switch (kind) {
            case TUMBLE_START:
            case TUMBLE_END:
            case HOP_START:
            ...
            case SESSION_START:
            case SESSION_END:
                return new org.apache.calcite.sql.SqlGroupedWindowFunction(
                        name,
                        kind,
                        this,
    ...
    public List<org.apache.calcite.sql.SqlGroupedWindowFunction> getAuxiliaryFunctions() {
