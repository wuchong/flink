...
import org.apache.flink.table.codegen.CodeGenUtils.BINARY_STRING
import org.apache.flink.table.codegen.{CodeGeneratorContext, GeneratedExpression}

case class ConcatCodeGen(operands: Seq[GeneratedExpression]) extends ExprCodeGen {
...
case class ConcatWsCodeGen(operands: Seq[GeneratedExpression]) extends ExprCodeGen {
