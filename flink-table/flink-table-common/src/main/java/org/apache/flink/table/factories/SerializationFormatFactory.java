...
/**
 * Factory for creating a {@link FormatWriterProvider} for {@link SerializationSchema}.
 *
 * @see FactoryUtil#createTableFactoryHelper(DynamicTableFactory, DynamicTableFactory.Context)
 */
@PublicEvolving
public interface SerializationFormatFactory extends FormatWriterFactory<SerializationSchema<RowData>> {
