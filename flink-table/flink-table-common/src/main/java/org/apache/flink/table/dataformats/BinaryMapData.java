...
import static org.apache.flink.table.types.logical.utils.LogicalTypeUtils.internalConversionClass;
...
public final class BinaryMapData extends BinarySection implements MapData {
	...
	public Map<?, ?> toJavaMap(LogicalType keyType, LogicalType valueType) {
		Object[] keyArray = keys.toClassArray(keyType, internalConversionClass(keyType));
		Object[] valueArray = values.toClassArray(valueType, internalConversionClass(valueType));
