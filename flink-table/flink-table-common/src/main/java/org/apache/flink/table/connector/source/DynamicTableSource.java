...
public interface DynamicTableSource {
	...
	/**
	 * Context for creating runtime implementation via a {@link ScanTableSource.ScanRuntimeProvider}
	 * for {@link ScanTableSource} and a {@link LookupTableSource.LookupRuntimeProvider} for
	 ...
	 *
	 * <p>Methods should be called in {@link ScanTableSource#getScanRuntimeProvider(ScanTableSource.Context)}
	 * or {@link LookupTableSource#getLookupRuntimeProvider(LookupTableSource.Context)}. The returned instances
