 ...
 * time called.</p>
 */
public interface TypedGetterSetters {
	 ...
	 */
	void setDecimal(int ordinal, Decimal value, int precision);
	...
	static Object get(TypedGetterSetters row, int ordinal, LogicalType type) {
	 ...
	 */
	static BiFunction<TypedGetterSetters, Integer, Object> getAccessor(LogicalType type) {
		// TODO
		return null;
	}

	static BiConsumer<TypedGetterSetters, Object> getWriter(int ordinal, LogicalType type) {
		// TODO
		return null;
	}
}
