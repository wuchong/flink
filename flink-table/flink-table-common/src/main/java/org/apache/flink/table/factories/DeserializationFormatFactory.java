...
/**
 * Factory for creating a {@link FormatReaderProvider} for {@link DeserializationSchema}.
 *
 * @see FactoryUtil#createTableFactoryHelper(DynamicTableFactory, DynamicTableFactory.Context)
 */
@PublicEvolving
public interface DeserializationFormatFactory extends FormatReaderFactory<DeserializationSchema<RowData>> {
