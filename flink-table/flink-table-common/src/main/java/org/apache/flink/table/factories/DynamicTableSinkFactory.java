 ...
 */
@PublicEvolving
public interface DynamicTableSinkFactory extends TableFactory {

	/**
	 * Creates and configures a {@link DynamicTableSink} based on the given {@link Context}.
	 *
	 * @param context context of this table source.
	 * @return the configured table source.
	 */
	DynamicTableSink createTableSink(Context context);
