...
import static org.apache.flink.connectors.jdbc.catalog.PostgresCatalog.DEFAULT_DATABASE;
...
public class PostgresCatalogTestBase {
	...
	public static void init() throws SQLException {
		...
		catalog = new PostgresCatalog(TEST_CATALOG_NAME, DEFAULT_DATABASE, TEST_USERNAME, TEST_PWD, baseUrl);
	...
	public static void createTable(PostgresTablePath tablePath, String tableSchemaSql) throws SQLException {
		executeSQL(DEFAULT_DATABASE, String.format("CREATE TABLE %s(%s);", tablePath.getFullPath(), tableSchemaSql));
	}
