...
import org.apache.flink.table.accumulator.{AccumulatorSpec, StateAccumulatorFactory}
...
class GroupAggProcessFunction(
    ...
    private val lazyAccSpecs: Map[String, StateDescriptor[_, _]])
  ...
  override def open(config: Configuration) {
    ...
    val stateAccFactory = new StateAccumulatorFactory(getRuntimeContext, lazyAccSpecs)
    function.setAccumulatorFactory(stateAccFactory)
