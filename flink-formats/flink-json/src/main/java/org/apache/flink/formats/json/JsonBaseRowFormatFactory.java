...
public class JsonBaseRowFormatFactory extends TableFormatFactoryBase<BaseRow>
		implements DeserializationSchemaFactory<BaseRow> {

	public JsonBaseRowFormatFactory() {
		super(JsonValidator.FORMAT_TYPE_VALUE, 2, true);
	}
	...
	@Override
	public DeserializationSchema<BaseRow> createDeserializationSchema(Map<String, String> properties) {
